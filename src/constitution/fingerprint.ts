 ...
 */
function canonicalBasisPayload(basis: DecisionBasis): string {
  const payload = {
    proposal: {
 ...
 */
export function computeDecisionBasisFingerprint(basis: DecisionBasis): string {
 ...
 */
export function fingerprintWorkflowSpec(spec: WorkflowSpec): string {
 ...
 */
export function verifyDecisionBasisFingerprint(
  basis:    DecisionBasis,
  expected: string,
