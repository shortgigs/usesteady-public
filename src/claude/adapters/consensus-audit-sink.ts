...
export function resolveConsensusAuditDir(): string {
...
export function consensusAuditLogPath(dir: string): string {
 ...
 * documents.
 */
export function appendConsensusAuditRecord(
  dir: string,
  record: ConsensusAuditRecord,
): void {
