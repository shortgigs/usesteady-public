...
export {
  ...
  PENDING_AFFECTED_RESOURCES_LIMIT,
  PENDING_MODEL_ADVISORIES_LIMIT,
  PENDING_MODEL_ADVISORY_EXPLANATION_LIMIT,
  PENDING_MODEL_ADVISORY_KINDS,
  buildPendingApprovalPayload,
  validatePendingApprovalPayload,
  type PendingApprovalRisk,
  type PendingActionType,
  type ResourceChangeType,
  type PendingAffectedResource,
  type PendingApprovalSystemWill,
  type PendingApprovalPayloadV1,
  type PendingApprovalInput,
  type PendingApprovalModelAdvisory,
  type PendingModelAdvisoryKind,
...
export {
  ...
  selectDecisionForStep,
  selectDecisionForStepAndCycle,
  interpretDecisionStatus,
  interpretDecision,
...
export {
  ...
  PORTAL_APPROVALS_URL_ENV,
  PORTAL_TOKEN_ENV,
  type PortalApprovalsConfig,
  type PortalApprovalsDisabledReason,
} from "./opt-in.js";
...
export {
  ...
  withdrawPendingApprovalGate,
  type BridgeFallbackReason,
  type BridgeOutcome,
  type BridgeOptions,
} from "./bridge.js";
...
export {
  ...
  resolveWebConfirmYes,
  verifyRemoteEntryAuthority,
  type RemoteApprovalDecision,
  type RemoteAuthorityEvidence,
  type ResolveRemoteApprovalOptions,
