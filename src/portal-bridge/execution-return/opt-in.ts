...
export type PortalReportingConfig =
  ...
  | { readonly enabled: false; readonly reason: PortalReportingDisabledReason };

export type PortalReportingDisabledReason =
  | "opt_in_off"
  | "no_url"
  | "no_token"
  | "invalid_runs_url_suffix";
 ...
 */
export function normalizePortalRunsBaseUrl(
  raw: string,
): { readonly ok: true; readonly url: string } | { readonly ok: false; readonly reason: "invalid_runs_url_suffix" } {
