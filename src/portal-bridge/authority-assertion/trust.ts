...
export type PortalAuthorityTrustResolution =
  ...
  | { readonly status: "configured"; readonly trust: PortalAuthorityTrust }
  | { readonly status: "misconfigured"; readonly reason: string };

function isValidEd25519SpkiBase64(value: string): boolean {
  try {
...
export function loadPortalAuthorityTrust(
  env: Readonly<Record<string, string | undefined>> = process.env,
): PortalAuthorityTrustResolution {
