...
export type CrossSurfaceArtifacts = {
  ...
  readonly approvalParity: { readonly decisionBasisFingerprint: string };
};
 ...
 */
export function synthesizeFirstTaskFromNL(rawInput: string): WorkflowTaskSpec {
 ...
 */
export function buildSynthesizedSpecFromNL(rawInput: string, name: string): WorkflowSpec {
...
export async function computeArtifactsForSpec(args: {
  ...
  let surface: RoutingSurface | undefined;
  let intentReflection: unknown = null;
...
export function canonicalizeArtifacts(a: CrossSurfaceArtifacts): string {
  return canonicalize({
    safety: a.safety,
    surface: a.surface,
 ...
 */
export function surfaceParityKey(a: CrossSurfaceArtifacts): string {
  return canonicalize({
    safety: a.safety,
    surface: a.surface,
    intentReflection: a.intentReflection,
 ...
 */
export function proposalContentKey(basis: DecisionBasis): string {
