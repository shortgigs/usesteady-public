...
import { scheduleFlush }        from "../../friction/client.js";
...
async function ensureAuth(): Promise<string> {
  ...
  if (token.githubEmail) print(`  Email: ${token.githubEmail}`);
  print("");
...
type FrictionKindManual = "ux-block" | "install-error" | "manual-cli";

async function selectKind(rl: SessionController): Promise<FrictionKindManual> {
