...
function extensionFromSegment(segment: string): string | null {
  ...
  if (ext.length === 0 || ext.length > 10) return null;
 ...
 */
export function findExtensionBearingParentSegment(
  path: string,
): ExtensionBearingParentHit | null {
