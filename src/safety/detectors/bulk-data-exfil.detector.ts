 ...
 */
const HIGH_CONFIDENCE_PATTERNS: ReadonlyArray<LabeledPattern> = [
...
function findMatch(input: string): LabeledPattern | null {
  ...
  if (isBulkExfil(input)) return BULK_EXFIL_COMBO;
  return null;
}

export const bulkDataExfilDetector: SafetyDetector = {
