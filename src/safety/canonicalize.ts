 ...
 */
export function canonicalizeForSafety(raw: string): string {
  if (typeof raw !== "string") {
    throw new CanonicalizationError(
      "Input is not a string; canonicalization aborted.",
    );
  }
  ...
  try {
    ...
    throw new CanonicalizationError(
      "NFKC normalization failed; canonicalization aborted.",
      err,
    );
  }
  ...
  try {
    ...
    throw new CanonicalizationError(
      "Zero-width / bidi stripping failed; canonicalization aborted.",
      err,
    );
  }
