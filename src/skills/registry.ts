 ...
 */
export function getTriggerableSkills(
  registry: LoadedSkillRegistry,
 ...
 */
export function shouldConsultSkills(
  registry: LoadedSkillRegistry,
  triggerReason: TriggerReason,
): boolean {
 ...
 */
export function getRegistryStats(registry: LoadedSkillRegistry): RegistryStats {
  return {
...
export function getSkillSummaries(
  registry: LoadedSkillRegistry,
): Readonly<Record<SkillKind, readonly SkillSummary[]>> {
