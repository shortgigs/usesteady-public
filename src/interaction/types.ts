...
export type InteractionEvent =
  ...
  | { readonly type: "unsupported_recovered"; readonly recoveryStyle: "syntax_hint" | "example_used" | "stepwise_followed" }
  | { readonly type: "color_intent_observed" }   // visual_color guided_recovery + bridgeFired
  | { readonly type: "text_intent_observed" }    // text_change guided_recovery + bridgeFired
  | { readonly type: "config_intent_observed" }; // config_change guided_recovery + bridgeFired
