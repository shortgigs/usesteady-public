/**
 * Deterministic replay namespace trace per-scope I/O identity.
...
export function replayWorkerPerScopeIoId(input: {
  readonly replay_execution_id: string;
  readonly replay_worker_per_scope_io_scope: ReplayNamespaceTraceLineAppendScope;
...
export function replayNamespaceTraceLineId(input: {
