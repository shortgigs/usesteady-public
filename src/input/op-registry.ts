 ...
 */
export const OPERATION_REGISTRY: Readonly<Record<OperationType, OperationSchema>> = Object.freeze({
  ...
  append: Object.freeze({
    type: "append",
    required: Object.freeze(["file", "text"]) as readonly string[],
    optional: Object.freeze([]) as readonly string[],
  ...
  run: Object.freeze({
    type: "run",
    required: Object.freeze(["command"]) as readonly string[],
    optional: Object.freeze([]) as readonly string[],
 ...
 */
export const ALL_OPERATION_TYPES: readonly OperationType[] = Object.freeze([
  "create",
  "create_dir",
  "delete",
  "rename",
 ...
 */
export function getOperationSchema(type: OperationType): OperationSchema {
 ...
 */
export function isKnownOperationType(value: unknown): value is OperationType {
  return typeof value === "string"
    && (ALL_OPERATION_TYPES as readonly string[]).includes(value);
}
 ...
 */
export function listOperationSummaries(): readonly string[] {
