...
const INVESTIGATION_STEPS: readonly CompletionNextStep[] = [
  {
    type:  "read_first",
...
const OPERATION_STEPS: readonly CompletionNextStep[] = [
  {
    type:  "read_first",
...
const CONTENT_ITERATION_STEPS: readonly CompletionNextStep[] = [
  {
    type:  "read_first",
...
const CODE_PATCH_STEPS: readonly CompletionNextStep[] = [
  {
    type:  "read_first",
...
const UNKNOWN_STEPS: readonly CompletionNextStep[] = [
  {
    type:  "read_first",
 ...
 */
const BOUNDARY_STEPS: readonly CompletionNextStep[] = [
  {
    type:  "use_exact_format",
 ...
 */
export function getSilentGuidanceSteps(
  mode: SilentGuidanceMode,
