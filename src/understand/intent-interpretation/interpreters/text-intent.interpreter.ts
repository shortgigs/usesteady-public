...
const TEXT_VERBS_RE =
  /\b(change|update|rename|edit|modify|rewrite|replace)\b/i;

const TEXT_TARGETS_RE =
  /\b(heading|headline|label|copy|title|caption|paragraph|message|description|placeholder|content|wording|phrase|sentence|text)\b/i;

export const textIntentInterpreter: IntentInterpreter = {
  id: "text_intent",
  priority: 30,
  ...
  interpret(input): IntentInterpretation | null {
    ...
    if (verbMatch === null || targetMatch === null) return null;
