...
const ENRICHED_STEP_LABELS = {
    visual_color: {
        read_first: 'Open the component file first to find the current color value: "<file>"',
    ...
    text_change: {
        read_first: 'Open the file first to find the current text value: "<file>"',
    ...
    config_change: {
        read_first: 'Open the config file first to find the current setting: "<file>"',
    ...
    workflow_operation: {
        read_first: "Open the file first to check the current state before making changes.",
        use_exact_format: 'To commit, use the run format: run git commit -m "<your message here>"',
        add_missing_field: "Add the specific commit message that describes the change.",
    },
};
