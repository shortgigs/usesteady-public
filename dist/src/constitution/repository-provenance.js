...
export const REPOSITORY_PROVENANCE_UNAVAILABLE = {
    identity: null,
    commit: null,
    dirty: null,
};
 ...
 */
export function captureRepositoryProvenance(workspaceRoot) {
    if (!workspaceRoot)
        return REPOSITORY_PROVENANCE_UNAVAILABLE;
...
//# sourceMappingURL=repository-provenance.js.map