...
// ??? Core factory ??????????????????????????????????????????????????????????????
export function recomputeEnvelopeIdentity(envelope) {
 ...
 */
export function createEnvelope(type, payload, source, refs) {
    const meta = { source, deterministic: true };
 ...
 */
export function createArtifactEnvelope(payload, refs) {
 ...
 */
export function createExecutionTraceEnvelope(payload, refs) {
 ...
 */
export function createReplayReportEnvelope(payload, refs) {
 ...
 */
export function createCursorHandoffEnvelope(payload, refs) {
 ...
 */
export function createCursorReceiptEnvelope(payload, refs) {
 ...
 */
export function createCursorRefusedEnvelope(payload, refs) {
 ...
 */
export function createClaudeHandoffEnvelope(payload, refs) {
 ...
 */
export function createClaudeReceiptEnvelope(payload, refs) {
 ...
 */
export function createClaudeRefusedEnvelope(payload, refs) {
 ...
 */
export function createModelAdvisoryEnvelope(payload, refs) {
 ...
 */
export function createModelEvidenceBasisEnvelope(payload, refs) {
 ...
 */
export function createModelPositionRetirementEnvelope(payload, refs) {
    return createEnvelope("ucp.model_position_retirement.v1", payload, "claude_delivery_gate", refs);
}
export function createExecutorReportEnvelope(payload, refs) {
    return createEnvelope("ucp.executor_report.v1", payload, "workflow_coordinator", refs);
}
export function createOutcomeObservationEnvelope(payload, refs) {
    return createEnvelope("ucp.outcome_observation.v1", payload, "workflow_coordinator", refs);
}
export function createOutcomeReconciliationEnvelope(payload, refs) {
 ...
 * refs.rootId   = intent envelope ID
 */
export function createRetiredPositionReassertionEnvelope(payload, refs) {
    return createEnvelope("ucp.retired_position_reassertion.v1", payload, "claude_delivery_gate", refs);
}
 ...
 */
export function createReminderExecutionEnvelope(payload, refs) {
 ...
 */
export function createWorkflowRunEnvelope(payload, refs) {
 ...
 */
export function createCommandEnvelope(payload, refs) {
 ...
 */
export function createExecutionResultEnvelope(payload, refs) {
