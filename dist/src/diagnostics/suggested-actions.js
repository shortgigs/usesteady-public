...
export const SUGGESTED_ACTION_BY_CODE = {
    ...
    invoice_projection_unavailable: "Verify billing projections in portal dashboard",
...
export function suggestedActionForCode(code) {
