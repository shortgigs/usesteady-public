 ...
 */
export declare function escapeControlForInline(raw: string): string;
export declare const LIFECYCLE_PARSED = "[parsed]";
export declare const LIFECYCLE_NEEDS_CONFIRMATION = "[ ? ]";
export declare const LIFECYCLE_DONE = "[done]";
//# sourceMappingURL=render-escape.d.ts.map