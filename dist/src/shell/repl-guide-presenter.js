...
export const REPL_CANONICAL_HEADLINE = "I need a complete instruction in one line.";
/** Fixed examples; governance-aligned with OPERATION_REGISTRY formats. */
export const REPL_CANONICAL_EXAMPLES = [
    "delete file b.ts",
    "rename a.ts to b.ts",
 ...
 */
export function renderReplCursorFrame(state) {
...
//# sourceMappingURL=repl-guide-presenter.js.map