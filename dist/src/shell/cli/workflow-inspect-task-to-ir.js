 ...
 */
function resolveOccurrence(req) {
    if (req === undefined)
        return "first";
    return req;
}
 ...
 */
export function specTaskToIROperation(task) {
