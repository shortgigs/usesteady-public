 ...
 */
export declare function hasMatchedOuterAsciiPair(s: string): boolean;
export declare function hasMatchedOuterSmartPair(s: string): boolean;
/**
...
//# sourceMappingURL=normalize-prompt-text.d.ts.map