...
export type SynthesisResult = {
    readonly ok: true;
    readonly fields: SynthesizedTaskFields;
} | {
    readonly ok: false;
 ...
 */
export declare function isNlRecoveryEligibleFailure(result: Extract<SynthesisResult, {
    ok: false;
}>): boolean;
/**
 ...
 */
export declare function synthesizeStructuredFieldsFromNL(input: string): SynthesisResult;
//# sourceMappingURL=spec-nl-synth.d.ts.map