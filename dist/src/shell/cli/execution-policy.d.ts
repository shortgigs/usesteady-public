 ...
 */
export declare const BATCH_FAIL_FAST_ENV = "USESTEADY_BATCH_FAIL_FAST";
/** Resolve the policy from the environment. Default = "interactive". */
export declare function resolveExecutionPolicy(env?: NodeJS.ProcessEnv): ExecutionPolicy;
/**
 ...
 */
export declare function shouldBatchFailFast(params: {
