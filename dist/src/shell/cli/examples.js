 ...
 */
export function buildInvocationPatternsCatalog() {
    const patterns = [
        Object.freeze({
            id: "json",
 ...
 */
export function renderExamplesJson() {
 ...
 */
export function renderExamplesText() {
