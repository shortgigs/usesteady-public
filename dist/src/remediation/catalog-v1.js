 ...
 */
export const EXECUTION_CAPABILITY_CATALOG_V1 = [
    {
        capability_id: "CAP-001",
        slug: "refresh_entitlement_cache",
        title: "Refresh entitlement cache (read-only issuer path)",
        description: "Bounds execution to read-only issuer fetch and cache refresh — does not issue or revoke entitlement",
...
//# sourceMappingURL=catalog-v1.js.map