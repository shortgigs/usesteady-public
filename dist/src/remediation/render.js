 ...
 */
export const REMEDIATION_PROPOSALS_DISCLAIMER = "These are candidates only. Nothing has been executed.";
export function renderRemediationProposalsSection(record) {
    const lines = [
        "",
    ...
    lines.push("  Capability bounds future execution class — resolution and execution remain blocked.");
    lines.push("");
    return lines.join("\n");
}
