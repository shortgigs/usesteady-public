 ...
 */
import type { ConsensusAuditRecord } from "./multi-llm-types.js";
export declare const CONSENSUS_AUDIT_LOG_FILENAME = "consensus-audit.jsonl";
export declare const CONSENSUS_AUDIT_DIR_ENV = "USESTEADY_CONSENSUS_AUDIT_DIR";
/** Resolve the directory holding the durable consensus audit log. */
export declare function resolveConsensusAuditDir(): string;
/** Absolute path of the durable consensus audit log for a directory. */
export declare function consensusAuditLogPath(dir: string): string;
/**
 ...
 * documents.
 */
export declare function appendConsensusAuditRecord(dir: string, record: ConsensusAuditRecord): void;
//# sourceMappingURL=consensus-audit-sink.d.ts.map