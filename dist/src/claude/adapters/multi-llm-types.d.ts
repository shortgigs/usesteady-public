 ...
 */
export type OperationClass = "read_only" | "artifact_delivery" | "execution_request" | "scope_question" | "execution_error" | "refusal" | "unknown";
/**
 ...
 */
export type RationaleCategory = "scope" | "safety" | "execution_feasibility" | "policy" | "unknown";
/**
 ...
 */
export type QuorumState = "unanimous" | "primary_only" | "scope_blocked" | "no_quorum" | "timeout";
/**
 ...
 */
export type PolicyMode = "claude" | "multi" | "multi-strict";
/**
...
export declare const DEFAULT_MULTI_LLM_OPTIONS: {
    readonly maxRounds: 3;
    readonly pluginTimeoutMs: 15000;
    readonly roundTimeoutMs: 20000;
    readonly requireUnanimity: false;
};
export declare const MAX_OBSERVATION_SUMMARY_CHARS = 500;
/**
...
export declare function buildReviewPayload(originalRequestId: string, priorNormalizedOutputs: readonly NormalizedDecision[], errorCategory: ReviewPayload["errorCategory"], rawObservation: string): ReviewPayload;
/**
...
export type ParticipantRawPosition = {
     ...
     */
    readonly advisoryPositions?: readonly {
 ...
 */
export declare function extractRawPosition(response: ClaudeDeliveryResponse): ParticipantRawPosition;
 ...
 */
export declare function normalizeResponse(request: ClaudeDeliveryRequest, response: ClaudeDeliveryResponse): NormalizedDecision;
export type PolicyEvaluation = {
    readonly quorumState: "unanimous" | "primary_only";
    readonly decision: NormalizedDecision;
} | {
    readonly quorumState: "scope_blocked";
    readonly decision: NormalizedDecision;
} | {
    readonly quorumState: "no_quorum" | "timeout";
 ...
 */
export declare function evaluatePolicy(decisions: readonly NormalizedDecision[], primaryDecision: NormalizedDecision, options: Pick<MultiLlmOptions, "requireUnanimity">, timedOut?: boolean): PolicyEvaluation;
//# sourceMappingURL=multi-llm-types.d.ts.map