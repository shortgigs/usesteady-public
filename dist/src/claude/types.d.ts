 ...
 */
export type ClaudeDeliveryResponse = ClaudeAccepted | ClaudeRefusedDueToScope | ClaudeRefusedDueToExecutionError | ClaudeAdvisoryPositions;
/**
 ...
 */
export type ModelAdvisoryKind = "warning" | "recommend_against" | "uncertainty" | "alternative";
/** Closed-enum membership list for runtime validation. */
export declare const MODEL_ADVISORY_KINDS: readonly ModelAdvisoryKind[];
/**
 ...
 */
export declare function canonicalModelAdvisoryEvent(position: ModelAdvisoryPosition): {
    readonly artifactId: string;
    readonly explanation: string;
    readonly kind: ModelAdvisoryKind;
    readonly model: string;
