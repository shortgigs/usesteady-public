 ...
 */
export function isClarifyClass(intent) {
    const t = intent.trim();
    if (t.length === 0)
        return false;
    if (/\?\s*$/.test(t))
 ...
 */
function successMeasureEcho(statement) {
...
function restate(intent) {
    return intent.trim().replace(/[.\s]+$/, "");
}
export function generateClarify(intent) {
...
//# sourceMappingURL=clarify-surface.js.map