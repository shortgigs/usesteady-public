...
function headlineForDeliverableType(deliverableType) {
...
export function isPlanningReviewSpec(spec) {
    return (spec.planningReviewHeadline !== undefined ||
...
function workPlanToTasks(workPlan) {
 ...
 */
export function buildPlanningReviewSpecFromConfirmed(confirmed) {
...
function rawInputName(confirmed) {
...
//# sourceMappingURL=planning-review-spec.js.map