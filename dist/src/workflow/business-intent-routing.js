 ...
 */
export function isBusinessIntentFrame(intent) {
    const t = intent.trim();
    return (
 ...
 */
export function shouldRouteToWorkPlanEngine(source, hasConfirmedUnderstanding, intent) {
    return (source !== "ir" &&
        (source !== "intake" ||
...
//# sourceMappingURL=business-intent-routing.js.map