...
export type WorkspaceContextProbeFailureReason = "missing_root" | "not_found" | "not_directory" | "not_readable";
export type WorkspaceContextProbeResult = {
    readonly ok: true;
    readonly context: WorkspaceContextProbe;
} | {
    readonly ok: false;
    readonly reason: WorkspaceContextProbeFailureReason;
};
