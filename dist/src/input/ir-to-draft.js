 ...
 */
export function irOperationToJsonDraftTask(op) {
    switch (op.type) {
        case "rename": {
        ...
        case "create_dir":
            throw new Error("irOperationToJsonDraftTask: create_dir does not have a DraftTask.action variant. " +
...
//# sourceMappingURL=ir-to-draft.js.map