 ...
 */
export declare function isReplayableCommandShape(command: unknown): boolean;
 ...
 * to call this.
 */
export declare function classifyInScopeCommand(command: string): InScopeCommand;
