...
// any host.
export function isContainedRelativePath(p) {
 ...
 */
export function isReplayableTaskSpec(spec) {
    ...
    switch (spec.operationType) {
        ...
        default:
            ...
            return Boolean(spec.structuredReplace
 ...
 */
export function classifyForReplay(ir) {
