...
import { redactAffectedResources } from "./redact.js";
/**
 ...
 */
export function summarizeDecisions(steps, breakGlass) {
    let approved = 0;
    let rejected = 0;
 ...
 */
export function stepsToAffectedResources(_steps) {
    return [];
}
/**
 ...
 */
export function mapRunToExecutionReturnInput(storeDir, sessionId, meta) {
    ...
    const { kept } = redactAffectedResources(stepsToAffectedResources(steps), meta.redaction);
