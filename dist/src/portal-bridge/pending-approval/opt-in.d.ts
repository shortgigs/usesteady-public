...
export type PortalApprovalsConfig = {
    ...
    readonly reason: PortalApprovalsDisabledReason;
};
export type PortalApprovalsDisabledReason = "opt_in_off" | "no_url" | "no_token";
export declare const PORTAL_APPROVALS_URL_ENV = "USESTEADY_PORTAL_APPROVALS_URL";
/**
...
export declare function resolvePortalApprovals(input: {
