 ...
 */
export declare const AUTHORITY_ASSERTION_SCHEMA: "usesteady.authority_assertion.v1";
export declare const AUTHORITY_ASSERTION_V2_SCHEMA: "usesteady.authority_assertion.v2";
export declare const DECISION_ORIGIN_SCHEMA: "usesteady.decision_origin.v1";
export declare const RETIREMENT_AUTHORITY_ASSERTION_V3_SCHEMA: "usesteady.authority_assertion.v3";
export declare const RETIREMENT_DECISION_ORIGIN_V2_SCHEMA: "usesteady.decision_origin.v2";
/**
 ...
 * approval.
 */
export declare const AUTHORITY_DECISION_RELATION_SUPERSESSION: "proceed_despite_model_position";
/**
...
export type AuthorityDecisionRelation = typeof AUTHORITY_DECISION_RELATION_SUPERSESSION | typeof AUTHORITY_DECISION_RELATION_RETIREMENT;
...
export type AuthorityAssertion = AuthorityAssertionV1 | DecisionOriginAuthorityAssertionV2 | RetirementAuthorityAssertionV3;
...
export type AuthorityVerificationFailure = "malformed_assertion" | "schema_mismatch" | "unknown_key_id" | "embedded_key_mismatch" | "invalid_signature" | `binding_mismatch:${string}`;
export type AuthorityVerificationResult = {
    readonly ok: true;
    readonly assertion: AuthorityAssertionV1;
} | {
    readonly ok: false;
    readonly reason: AuthorityVerificationFailure;
};
...
export type MappedRetirementDiagnostic = "mapped_relation_reference_missing" | "mapped_store_configuration_required" | "mapped_store_unavailable" | "mapped_o_reference_absent" | "mapped_o_reference_corrupt" | "mapped_e_reference_absent" | "mapped_e_reference_corrupt";
