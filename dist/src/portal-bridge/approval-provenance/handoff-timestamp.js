...
function confirmedAtMsFromSession(session) {
    if (!session)
        return null;
 ...
 */
export function maxHandoffConfirmedAtFromSessions(sessions) {
    let maxMs = -1;
...
export function maxHandoffConfirmedAtIso(storeDir, workflowRunId) {
...
//# sourceMappingURL=handoff-timestamp.js.map